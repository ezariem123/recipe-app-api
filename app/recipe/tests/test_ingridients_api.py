...
class PrivateIngridientsApiTests(TestCase):
    ...
    def test_create_ingridients_successfull(self):
        """Test creating new ingridients"""
        payload = {'name': 'Cherry'}
        self.client.post(INGRIDEINTS_URL, payload)
    ...
    def test_create_ingridients_invalid(self):
        """Test creating ingridient with invalid payload"""
        payload = {'name': ''}
        res = self.client.post(INGRIDEINTS_URL, payload)
